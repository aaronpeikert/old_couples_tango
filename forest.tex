...
\scriptsize {\lolit Notes:} \href{https://github.com/aaronpeikert/ForestEden}{\tt \scriptsize
  \color{foreground} https://github.com/aaronpeikert/ForestEden}
}
...
\begin{frame}[c]{The Great Divide}
  ...
  \note{
  This epigram captures the unreasonable assumption behind trees that everyhing is a binary class and at the same time that a lot of things can be captures in two classes. This fundamental, but for all but the most trivial cases, false assumption is what centrally drives decision trees.
  }
\end{frame}
