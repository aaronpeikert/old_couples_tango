...
\begin{frame}[c]{Rolemodel Eve}
  ...
  \note{
    ...
    The order is determined by how well a condition maximizes the differences. The best performing condition determines the first split. This is called ``greedy", because what delivers at first the best results, may not perform best in the long run.
  }
\end{frame}
